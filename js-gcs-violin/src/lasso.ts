...
export default function() {
    ...
    var items : any,
        ...
        hoverSelect = true,
        targetArea: any,
        on:any = {start:function(){}, draw: function(){}, end: function(){}};

    // Function to execute on call
    function lasso(_this:any) {
        ...
        function dragstart() {
            ...
            items.nodes().forEach(function(e:any) {            
        ...
        function dragmove(this:any) {
            ...
            items.nodes().forEach(function(n:any) {
    ...
    lasso.closePathDistance  = function(_:any) {
    ...
    lasso.closePathSelect = function(_:any) {
    ...
    lasso.isPathClosed = function(_:any) {
    ...
    lasso.hoverSelect = function(_:any) {
    ...
    lasso.targetArea = function(_:any) {
